...
export default function ManageSchedule() {
  ...
  const findScheduleId = (day, period) => {
    let result
    classroomDetail.forEach(i => (i.day === day && i.period === period)&&(result = i.scheduleId));
    return result;
  }
  useEffect(() => {
                    ...
                    <div>
                      <Button
                        ...
                        onClick={() => {
                          axios
                            .delete(
                              `${process.env.REACT_APP_Backend_URI}api/Schedule/Delete-schedule/${findScheduleId("Monday", index+1)}`
                            )
                            .then(() => {
                              setDeleteModal({
                                ...deleteModal,
                  ...
                  <div>
                    <Button
                      ...
                      onClick={() => {
                        axios
                          .delete(
                            `${process.env.REACT_APP_Backend_URI}api/Schedule/Delete-schedule/${findScheduleId("Tuesday", index+1)}`
                          )
                          .then(() => {
                            setDeleteModal({
                              ...deleteModal,
                  ...
                  <div>
                    <Button
                      ...
                      onClick={() => {
                        axios
                          .delete(
                            `${process.env.REACT_APP_Backend_URI}api/Schedule/Delete-schedule/${findScheduleId("Wednesday", index+1)}`
                          )
                          .then(() => {
                            setDeleteModal({
                              ...deleteModal,
                  ...
                  <div>
                    <Button
                      ...
                      onClick={() => {
                        axios
                          .delete(
                            `${process.env.REACT_APP_Backend_URI}api/Schedule/Delete-schedule/${findScheduleId("Thursday", index+1)}`
                          )
                          .then(() => {
                            setDeleteModal({
                              ...deleteModal,
                  ...
                  <div>
                    <Button
                      ...
                      onClick={() => {
                        axios
                          .delete(
                            `${process.env.REACT_APP_Backend_URI}api/Schedule/Delete-schedule/${findScheduleId("Friday", index+1)}`
                          )
                          .then(() => {
                            setDeleteModal({
                              ...deleteModal,
                  ...
                  <div>
                    <Button
                      ...
                      onClick={() => {
                        axios
                          .delete(
                            `${process.env.REACT_APP_Backend_URI}api/Schedule/Delete-schedule/${findScheduleId("Saturday", index+1)}`
                          )
                          .then(() => {
                            setDeleteModal({
                              ...deleteModal,
